{{-- _skeleton-staff-keu-dashboard.blade.php --}}
<div id="skeleton-loader" class="container-fluid p-0">
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="row g-4 h-100">
                <div class="col-12 h-50 pb-2"><div class="card h-100 shadow-sm border-0 placeholder-glow"><div class="card-body text-center"><span class="placeholder col-8 rounded-pill mx-auto bg-secondary opacity-25 d-block" style="height: 28px;"></span></div></div></div>
                <div class="col-12 h-50 pt-2"><div class="card h-100 shadow-sm border-0 placeholder-glow"><div class="card-body text-center"><span class="placeholder col-8 rounded-pill mx-auto bg-secondary opacity-25 d-block" style="height: 28px;"></span></div></div></div>
            </div>
        </div>
    </div>
    {{-- 2. QUICK STATS (4) --}}
    ...
    {{-- 3. CHART --}}
    <div class="row g-4 mb-4">
        <div class="col-lg-12"><div class="card shadow-sm border-0 placeholder-glow"><div class="card-body pt-4"><span class="placeholder col-12 rounded-3 bg-secondary opacity-25" style="height: 350px;"></span></div></div></div>
    </div>
    {{-- 4. 2 TABLES --}}
    <div class="row g-4">
        @for ($i = 0; $i < 2; $i++)
        <div class="col-lg-6"><div class="card h-100 shadow-sm border-0 placeholder-glow"><div class="card-header border-bottom pb-3"><span class="placeholder col-5 rounded-pill bg-secondary opacity-25" style="height: 18px;"></span></div><div class="card-body">@for ($j = 0; $j < 5; $j++)<div class="d-flex align-items-center mb-3"><span class="placeholder col-10 rounded-pill bg-secondary opacity-25" style="height: 14px;"></span></div>@endfor</div></div></div>
        @endfor
    </div>
</div>
