...
<div class="row g-4 mb-4">
  ...
  <div class="col-xl-8 col-lg-7">
    <div class="card border-0 shadow-sm bg-gradient-success text-white h-100" style="border-radius: 16px;">
      <div class="card-body p-4 p-md-5 d-flex align-items-center position-relative overflow-hidden">
        <div class="row w-100 align-items-center position-relative z-1">
          <div class="col-md-8 text-md-start text-center mb-4 mb-md-0">
            <span class="badge bg-white text-success rounded-pill mb-3 fw-bold px-3 py-2 shadow-sm">Portal Staff Keuangan</span>
        ...
        <i class="ri ri-wallet-3-line position-absolute text-white"
    ...
    <div class="col-lg-12">
        <div class="card shadow-sm border-0 rounded-4">
            <div class="card-header bg-transparent border-0 pt-4 pb-0">
                <h5 class="card-title fw-bold m-0"><i class="ri ri-line-chart-line text-primary me-2"></i> Grafik Setoran Tervalidasi ({{ now()->year }})</h5>
            </div>
            <div class="card-body">
            ...
            <div class="table-responsive text-nowrap" style="max-height: 400px; overflow-y: auto;">
                <table class="table table-hover table-sm">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="2" class="text-center p-4 text-muted">Belum ada data setoran.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
            ...
            <div class="table-responsive text-nowrap" style="max-height: 400px; overflow-y: auto;">
                <table class="table table-hover table-sm">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="2" class="text-center p-4 text-success fw-medium"><i class="ri ri-check-double-line me-1"></i> Luar Biasa! Semua PKS sudah menyetor.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
