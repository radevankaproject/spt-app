                ...
                <div class="row g-6">
                    ...
                    <div class="col-md-4">
                        <div class="form-floating form-floating-outline">
                            <input type="number" step="0.01" class="form-control" id="estimated_area" name="estimated_area" value="{{ old('estimated_area', $parkingLocation->estimated_area) }}" min="0" />
                            <label for="estimated_area">Est. Luas Wilayah (m²)</label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-floating form-floating-outline">
                            <input type="number" class="form-control" id="estimated_srp_r2" name="estimated_srp_r2" value="{{ old('estimated_srp_r2', $parkingLocation->estimated_srp_r2) }}" min="0" />
                            <label for="estimated_srp_r2">Est. Jumlah SRP Roda 2</label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-floating form-floating-outline">
                            <input type="number" class="form-control" id="estimated_srp_r4" name="estimated_srp_r4" value="{{ old('estimated_srp_r4', $parkingLocation->estimated_srp_r4) }}" min="0" />
