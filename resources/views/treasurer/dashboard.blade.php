    ...
    <div class="col-xl-8 col-lg-7">
        <div class="card border-0 shadow-sm hero-card-treasurer text-white h-100" style="border-radius: 16px;">
            <div class="card-body p-4 p-md-5 d-flex align-items-center position-relative overflow-hidden">
                ...
                <i class="ri ri-safe-2-line position-absolute text-white" style="font-size: 220px; right: -20px; bottom: -40px; opacity: 0.1; transform: rotate(-10deg);"></i>
            </div>
        </div>
    </div>
        ...
        <div class="card border-0 shadow-sm rounded-4 h-100 quick-stat-card border-bottom border-warning border-3">
            <div class="card-body p-3">
                <div class="d-flex justify-content-between align-items-start mb-2">
                    ...
                    <div class="stat-card-icon bg-label-warning"><i class="ri ri-time-line ri-24px"></i></div>
                </div>
                <span class="badge bg-warning text-white rounded-pill px-2 py-1 small fw-bold shadow-sm"><i class="ri ri-alert-line align-bottom me-1"></i>Aksi Diperlukan</span>
            </div>
        </div>
    </div>
    <div class="col-md-3 col-6">
        <div class="card border-0 shadow-sm rounded-4 h-100 quick-stat-card border-bottom border-danger border-3">
            <div class="card-body p-3">
                <div class="d-flex justify-content-between align-items-start mb-2">
                    ...
                    <div class="stat-card-icon bg-label-danger"><i class="ri ri-wallet-3-line ri-24px"></i></div>
                </div>
        ...
        <div class="card border-0 shadow-sm rounded-4 h-100 quick-stat-card border-bottom border-success border-3">
            <div class="card-body p-3">
                <div class="d-flex justify-content-between align-items-start mb-2">
                    ...
                    <div class="stat-card-icon bg-label-success"><i class="ri ri-check-double-line ri-24px"></i></div>
                </div>
        ...
        <div class="card border-0 shadow-sm rounded-4 h-100 quick-stat-card border-bottom border-primary border-3">
            <div class="card-body p-3">
                <div class="d-flex justify-content-between align-items-start mb-2">
                    ...
                    <div class="stat-card-icon bg-label-primary"><i class="ri ri-bar-chart-box-line ri-24px"></i></div>
                </div>
    ...
    <div class="col-xl-7 col-lg-7">
        <div class="card border-0 shadow-sm rounded-4 h-100">
            <div class="card-header border-bottom bg-transparent py-3 d-flex justify-content-between align-items-center">
                <h6 class="mb-0 fw-bold"><i class="ri ri-error-warning-fill me-2 text-warning ri-lg"></i>Antrean Validasi Terbaru</h6>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                ...
                                <span class="text-muted small"><i class="ri ri-calendar-line align-bottom me-1"></i>{{ \Carbon\Carbon::parse($deposit->deposit_date)->translatedFormat('d M Y') }}</span>
                            </td>
                            <td>
